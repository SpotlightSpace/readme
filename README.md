...
|--------|--------------|---------------------------|-------------|
| 강태영 | Sub Leader   | ElasticSearch, SSE, 인덱싱 | [프로필](프로필) |
| 김동규 | Member       | 결제 및 동시성 문제 해결    | [프로필](프로필) |
| 박한진 | Member       | 리뷰 및 좋아요 기능 구현    | [프로필](프로필) |
| 조준호 | Leader       | CI/CD, 배치, 모니터링       | [프로필](프로필) |
| 최원   | Member       | 쿠폰 발급, 관리자 기능       | [프로필](프로필) |
...
<details>
  ...
  - **Spy 어노테이션**을 사용하여 단일 책임을 갖는 단위 테스트 작성  
  - [관련 링크](https://kty0602.tistory.com/80)  
</details>

<details>
  <summary style="font-size: 18px">📉 인덱스 도입으로 인한 쓰기 성능 저하 문제 해결</summary>
  - 인덱스 도입 후 10배 증가한 쓰기 성능 문제를 **ElasticSearch 도입**으로 개선  
  - [관련 링크](https://kty0602.tistory.com/81)  
</details>
